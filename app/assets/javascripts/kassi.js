...
function initialize_stripe_info_form(locale, person_id){
  auto_resize_text_areas("update_profile_description_text_area");
  $('input.text_field:first').focus();
  ...
  $(form_id).validate({
    rules: {
      ...
      "stripe_user_detail[last_name]": {required: true, maxlength: 30},
      "stripe_user_detail[dob(1i)]": {required: true, maxlength: 30},
      "stripe_user_detail[dob(2i)]": {required: true, maxlength: 30},
