  ...
  module Listing
    ...
    module Entity
      ...
      def listing(listing_model)
        Listing.call(EntityUtils.model_to_hash(listing_model).merge({price: listing_model.price, deposit_price: listing_model.deposit_price, shipping_price: listing_model.shipping_price, shipping_price_additional: listing_model.shipping_price_additional}))
      end
